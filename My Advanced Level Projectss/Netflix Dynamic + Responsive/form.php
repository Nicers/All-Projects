                ...
                <div class="w-full lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
                    ...
                    <form class="px-8 pt-6 pb-8 mb-4 bg-white rounded" method="post" action="">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full px-3 py-2 text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline" 
                               name="address" id="address" required></textarea>
                        </div>
                        <div class="mb-6 text-center">
                            <input class="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-full hover:bg-blue-700 focus:outline-none cursor-pointer focus:shadow-outline"
                                type="submit" name="btnregister" value="Register" />
                        </div>
                    </form>
                </div>
            </div>
